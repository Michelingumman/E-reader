...
# Example usage
extract_and_store_pdf_data(f'Conversion/Books/converted/{pdf_base_name}.json')
print(f"Text and page data saved to Conversion/Books/converted/{pdf_base_name}.json")
